      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan, index) => (
            <div
              key={index}
              className="border p-6 rounded-lg shadow-md bg-gray-100 dark:bg-gray-900"
            >
              <h3 className="text-2xl lg:text-3xl font-semibold text-gray-800 dark:text-white mb-4 font-geistSans">
                {plan.title}
              </h3>
              <p className="text-xl font-bold mb-4 text-gray-700 dark:text-gray-200">
                {plan.price}
              </p>
